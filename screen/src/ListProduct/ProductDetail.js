                                ...
                                fetch("http://125.253.123.20/managedevice/group.php", {
                                    ...
                                    .then((response) => {
                                        ...
                                        if (response2 == "true") {
                                            ...
                                            var chitietthietbi2 = JSON.parse(JSON.stringify(self.state.chitietthietbi))
                                            chitietthietbi2[0].catalogQuantity = soLuongSanPham;
                                            self.setState({
                                                chitietthietbi:chitietthietbi2
                                            })                                           
                            ...
                            let formData = new FormData();
                                ...
                                fetch("http://125.253.123.20/managedevice/group.php", {
                                    ...
                                    .then((response) => {
                                        ...
                                        var dataSearch2 = JSON.parse(JSON.stringify(this.props.dataSearch))
                                        var result = response.DANHSACHSANPHAM;
                                        dataSearch2.map((value)=> {
                                            result.map((value2)=> {
                                                if (value.catalogId == value2.catalogId) {
                                                    value.catalogQuantity = value2.catalogQuantity
                                                }
                                            })
                                        })
                                        this.props.saveDataSearch(dataSearch2);
                                    })
                        }}>
